                       ...
                       std::vector<int>& conteo)
{
    ...
    size_t nHilos = std::min((size_t)16, patrones.size());
...
{
    // Leer patrones
    std::ifstream archivoPatrones("ej2/patrones.txt");
    ...
    std::ifstream archivoTexto("ej2/texto.txt");
